...
import { generate as generateBlockCompose, templateMeta as blockComposeMeta } from './block-compose/index.js';
...
registerTemplate('block-compose', {
  ...blockComposeMeta,
  generate: generateBlockCompose,
});
...
export { generate as generateBlockCompose } from './block-compose/index.js';
