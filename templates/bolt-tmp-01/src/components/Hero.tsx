...
const trustBadges = [
  ...
  { icon: DollarSign, label: `${amountMin} – ${amountMax}`, sub: 'Flexible loan amounts' },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-28 md:pb-32">
          <div ref={ref} className="max-w-3xl">
            ...
            <p
              className={`text-lg sm:text-xl text-teal-100 leading-relaxed mb-10 max-w-2xl transition-all duration-700 delay-200 ${shouldAnimate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
            >
              {sub}
            </p>
            ...
            >
              <form onSubmit={handleZipSubmit} className="flex flex-col gap-2 max-w-sm">
                ...
                <p className="text-teal-200/70 text-xs pl-1">Soft inquiry only &middot; Data-driven lending decision</p>
              </form>
            </div>
