      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            ${amountMin} to ${amountMax} installment loans for veterinary care and pet expenses. All credit types welcome.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all">
              <div className="text-3xl font-bold text-white mb-1">${amountMax}</div>
