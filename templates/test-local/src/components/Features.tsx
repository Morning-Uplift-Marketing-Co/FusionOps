...
export default function Features({ accentColor = '#f97316', amountMin = '200', amountMax = '10000' }: FeaturesProps) {
  const features = [
    {
      title: "Flexible Loan Amounts",
      description: `Borrow anywhere from $${amountMin} to $${amountMax} based on your needs and qualifications.`,
