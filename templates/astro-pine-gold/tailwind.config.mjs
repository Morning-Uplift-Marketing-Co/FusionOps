export default {
  ...
  // Remove this line (or set to 'media') to use the OS preference instead.
  darkMode: 'class',
  theme: {
    extend: {
      colors: {
        // ── Semantic brand tokens ──────────────────────────────────────────
        // Change the HSL values in src/styles/global.css to retheme the site.
        ...
        // Use brand-blue for bold CTAs, electric highlights, open FAQ states.
        'brand-blue': { DEFAULT: 'hsl(var(--brand-blue) / <alpha-value>)' },
