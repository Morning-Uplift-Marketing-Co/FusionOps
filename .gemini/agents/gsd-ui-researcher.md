...
Use template from `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
