...
- Usage: Reference from command with `@H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
