...
<!-- For checkpoint task examples and patterns, see @H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/references/checkpoints.md -->
...
See `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
