...
- **Global scope**: `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/notes/`)
...
2. Glob `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/notes/` — works in any directory
