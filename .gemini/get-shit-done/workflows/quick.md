...
```bash
INIT=$(node "H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
