...
See H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/discovery.md
...
Use H:/DEV/projects/ppc_project/ppc-claude-web-V1/.gemini/get-shit-done/templates/discovery.md.
