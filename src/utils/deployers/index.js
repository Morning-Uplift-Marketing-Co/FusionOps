...
export const DEPLOY_TARGETS = [
  { id: "github-actions", label: "GitHub Actions (Astro Build)", icon: "⚙️", priority: 1, description: "Trigger CI — Astro builds correctly, no regex injection bugs" },
  { id: "cf-pages", label: "Cloudflare Pages", icon: "☁️", priority: 2, description: "Primary — fast, free, CF integration" },
  { id: "netlify", label: "Netlify", icon: "🔺", priority: 3, description: "Backup — diversify footprint" },
  { id: "vercel", label: "Vercel", icon: "▲", priority: 4, description: "Edge-first deploys with preview support" },
  { id: "cf-workers", label: "CF Workers Sites", icon: "⚡", priority: 5, description: "Edge logic — A/B test, geo-redirect" },
  { id: "git-push", label: "Git Push Pipeline", icon: "🧬", priority: 6, description: "Commit artifacts to repo and let CI deploy" },
];

/**
 * Deploy HTML to a specific target.
 * @param {string} target - One of: github-actions, cf-pages, netlify, vercel, cf-workers, git-push
