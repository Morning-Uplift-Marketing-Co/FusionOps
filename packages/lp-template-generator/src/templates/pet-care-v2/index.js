/**
 * Pet Care Loans Template
 * =======================
 * Mobile-first LP for pet financing.
 * Same architecture as installment-loans but pet-themed content.
 */
...
<head>
  ...
  <style>
    ...
    .hero{padding:60px 0 32px;background:linear-gradient(170deg,#0f4c3a 0%,#1a5c4b 50%,#0f3460 100%);color:#fff;position:relative;overflow:hidden}
    .hero::before{content:'🐾';position:absolute;top:20px;right:20px;font-size:120px;opacity:.06}
    ...
    .step-num{width:38px;height:38px;border-radius:10px;flex-shrink:0;background:linear-gradient(135deg,var(--primary),var(--primary-light));color:#fff;font-size:16px;font-weight:800;display:flex;align-items:center;justify-content:center}
    ...
    .service-card{background:var(--card);border-radius:14px;padding:18px;border:1px solid var(--border);text-align:center}
    .service-icon{font-size:28px;margin-bottom:8px}
    .service-card h4{font-size:13px;font-weight:700;margin-bottom:3px}
    .service-card p{font-size:11px;color:var(--fg-sub)}
    ...
    .cta-section{background:linear-gradient(170deg,#0f4c3a,#0f3460);padding:48px 0;text-align:center;color:#fff}
    ...
    .sticky-cta .btn-sm{background:linear-gradient(135deg,var(--primary),var(--primary-dark));color:#fff;padding:12px 20px;border-radius:10px;font-size:14px;font-weight:800;border:none;cursor:pointer;font-family:var(--font);white-space:nowrap}
    ...
    @media(max-width:768px){.hero-grid{display:flex;flex-direction:column;gap:20px}}
  </style>
</head>
<body>
  <header class="header"><div class="header-inner">
    <a class="logo"><span class="logo-icon">🐾</span> ${c.brand}</a>
  </div></header>
  ...
  <section class="hero" id="apply"><div class="container"><div class="hero-grid">
    <div class="hero-content" style="order:1">
      ...
      <p class="hero-sub">${c.sub} No credit impact to check options.</p>
    </div>
    <div style="order:0"><div class="hero-form">
      <div class="form-title">How much does your pet need?</div>
      <div class="form-subtitle">Quick approval · All credit types</div>
      <form id="heroForm">
  ...
  <section class="section"><div class="container">
    ...
    <div class="section-title">3 simple steps to pet care financing</div>
    <div class="steps-grid">
      <div class="step-card"><div class="step-num">1</div><div><h3>Tell us what you need</h3><p>Select amount for vet bills, surgery, or preventive care.</p></div></div>
      <div class="step-card"><div class="step-num">2</div><div><h3>Get matched</h3><p>We connect you with financing that fits your budget.</p></div></div>
      <div class="step-card"><div class="step-num">3</div><div><h3>Care for your pet</h3><p>Use funds at any vet. Flexible monthly payments.</p></div></div>
    </div>
  </div></section>

  <section class="section" style="background:var(--bg-warm)"><div class="container">
    <div class="section-label">● What We Cover</div>
    <div class="section-title">Financing for every pet care need</div>
    <div class="services-grid">
      <div class="service-card"><div class="service-icon">🏥</div><h4>Emergency Vet</h4><p>Unexpected injuries &amp; illness</p></div>
      <div class="service-card"><div class="service-icon">🦷</div><h4>Dental Care</h4><p>Cleanings, extractions, surgery</p></div>
      <div class="service-card"><div class="service-icon">💉</div><h4>Surgery</h4><p>Orthopedic, tumor, spay/neuter</p></div>
      <div class="service-card"><div class="service-icon">💊</div><h4>Medications</h4><p>Ongoing prescriptions &amp; treatment</p></div>
      <div class="service-card"><div class="service-icon">🐕</div><h4>Wellness</h4><p>Checkups, vaccines, preventive care</p></div>
      <div class="service-card"><div class="service-icon">✨</div><h4>Grooming</h4><p>Professional grooming &amp; spa</p></div>
    </div>
  </div></section>
  ...
  <section class="section" id="faq"><div class="container">
    ...
    <div class="faq-list">
      <div class="faq-item"><button class="faq-q">Will this affect my credit?<span class="faq-icon">+</span></button><div class="faq-a">No. Checking your options uses a soft inquiry only.</div></div>
      <div class="faq-item"><button class="faq-q">Can I use it at any vet?<span class="faq-icon">+</span></button><div class="faq-a">Yes. Funds are deposited to your account — use at any licensed veterinarian.</div></div>
      <div class="faq-item"><button class="faq-q">What amounts are available?<span class="faq-icon">+</span></button><div class="faq-a">${fmt(c.amountMin)} to ${fmt(c.amountMax)} depending on qualification.</div></div>
      <div class="faq-item"><button class="faq-q">How fast can I get funds?<span class="faq-icon">+</span></button><div class="faq-a">Most approvals same day. Funds deposited within 1 business day.</div></div>
      <div class="faq-item"><button class="faq-q">What if my pet needs care now?<span class="faq-icon">+</span></button><div class="faq-a">Apply now — our process takes only 2 minutes and approval is fast.</div></div>
    </div>
  </div></section>

  <section class="cta-section"><div class="container">
    <h2>Your pet deserves the best care 🐾</h2>
    <p>Check your financing options in under 2 minutes.</p>
  ...
  <div class="compliance"><div class="container">
    ...
    ${aprTableHTML(c)}
    <div class="compliance-text" style="margin-top:24px"><a href="#" onclick="openPopup('privacyPopup');return false">Privacy Policy</a> · <a href="#" onclick="openPopup('termsPopup');return false">Terms</a></div>
  </div></div>
  ...
  <div class="sticky-cta" id="stickyCta"><div class="sticky-cta-text">🐾 Pet financing up to ${fmt(c.amountMax)}<small>No credit impact</small></div><a href="#apply" class="btn-sm">${c.cta}</a></div>
